...
<div class="container container-fluid">
  ...
  $exec = `./runfactorio-task.sh --reset "../server/$server" "$serverwebhook" "$server"`;

  $exec = preg_replace('/\s+/', '', $exec);
  echo "Server normally reseting<br>";


  echo '<a class="btn btn-info" href="';
  echo "launchAdminLoading.php?serverchoose=$server";
  echo '" class="button">Go back to the pannel</a>';
  ?>
